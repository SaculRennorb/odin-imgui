...
struct ImGuiContext
{
    ...
    ImGuiInputSource        ActiveIdSource;                     // Activating source: ImGuiInputEventType_Mouse OR ImGuiInputSource_Keyboard OR ImGuiInputSource_Gamepad
    ...
    ImGuiInputSource        NavInputSource;                     // Keyboard or Gamepad mode? THIS CAN ONLY BE ImGuiInputSource_Keyboard or ImGuiInputEventType_Mouse
