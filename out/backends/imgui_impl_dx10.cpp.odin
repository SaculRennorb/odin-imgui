...
ImGui_ImplDX10_RenderDrawData :: proc(draw_data : ^ImDrawData)
{
    ...
    BACKUP_DX10_STATE :: struct
    {
        ...
        ScissorRects : [D3D10_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE]D3D10_RECT,
        Viewports : [D3D10_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE]D3D10_VIEWPORT,
...
ImGui_ImplDX10_RenderViewport :: proc(viewport : ^ImGuiViewport, rawptr)
{
    ...
    if (!(viewport.Flags & ImGuiViewportFlags_NoRendererClear))
        bd.pd3dDevice->ClearRenderTargetView(vd.RTView, (f32*)&clear_color);
