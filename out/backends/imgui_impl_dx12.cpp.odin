...
ImGui_ImplDX12_CreateFontsTexture :: proc()
{
    ...
    font_tex := &bd.FontTexture;
    {
        ...
        for i32 y = 0; y < height; y++
            memcpy((rawptr) ((uintptr_t) mapped + y * uploadPitch), pixels + y * width * 4, width * 4);
...
ImGui_ImplDX12_CreateDeviceObjects :: proc() -> bool
{
    ...
    // Create the root signature
    {
        ...
        if (d3d12_dll == nullptr)
        {
            ...
            for i32 i = 0; i < len(localD3d12Paths); i++
...
ImGui_ImplDX12_RenderWindow :: proc(viewport : ^ImGuiViewport, rawptr)
{
    ...
    if (!(viewport.Flags & ImGuiViewportFlags_NoRendererClear))
        cmd_list.ClearRenderTargetView(vd.FrameCtx[back_buffer_idx].RenderTargetCpuDescriptors, (f32*)&clear_color, 0, nullptr);
