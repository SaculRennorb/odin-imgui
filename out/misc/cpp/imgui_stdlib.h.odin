...
namespace ImGui
{
    ...
    bool  InputTextMultiline(const char* label, std::string* str, const ImVec2& size = ImVec2{0, 0}, ImGuiInputTextFlags flags = 0, ImGuiInputTextCallback callback = nullptr, rawptr user_data = nullptr);
