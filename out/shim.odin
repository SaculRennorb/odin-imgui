...
end :: proc { ImVector_end_0, ImVector_end_1, ImSpan_end_0, ImSpan_end_1 }
...
begin :: proc { ImVector_begin_0, ImVector_begin_1, ImSpan_begin_0, ImSpan_begin_1 }

resize :: proc { ImVector_resize_0, ImVector_resize_1 }

Contains :: proc { ImRect_Contains_0, ImRect_Contains_1 }

GetID :: proc { ImGuiWindow_GetID_0, ImGuiWindow_GetID_1, ImGuiWindow_GetID_2, ImGuiWindow_GetID_0, ImGuiWindow_GetID_0, ImGuiWindow_GetID_0 }
