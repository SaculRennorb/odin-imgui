...
ImGui_ImplDX12_InitInfo :: struct
{
    ...
    ImGui_ImplDX12_InitInfo()   { memset((rawptr)this, 0, size_of(*this)); }
};
...
ImGui_ImplDX12_RenderState :: struct
{
    Device : ^ID3D12Device,
